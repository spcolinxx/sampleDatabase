def trans_to_dict(dt):
    ...
    item_ls = ["sam_uni_id", "inv_id", "sam_cate_name", "stor_meth", "sam_qty",
                "acqui_time", "org_name",  "jur_per_id", "jur_per_type", "org_intro", "adr",
               "post_code", "manager_name", "tel", "email", "don_id", "gender", "date_of_bir"
        , "eth_gro", "nativ_pla", "bir_pla", "dise_name", "normal_gro", "upload_time"]
